        ...
        <section class="posts">
            ...
            <div class="posts__block">
				<?php while ( $author_posts->have_posts() ):
					...
					$post_meta_title = apply_filters('the_content', $post_meta['title']);
					$post_meta_description = apply_filters('the_content', $post_meta['description']);
					?>
                    <article class="posts__item">
                        <div class="posts__preview">
							<?= @app_get_image( [ 'id' => $post_meta['image'] ] ) ?>
                        </div>
                        <h3 class="posts__name"><?= @$post_meta_title ?></h3>
                        <p class="posts__excerpt"><?= @$post_meta_description ?></p>
